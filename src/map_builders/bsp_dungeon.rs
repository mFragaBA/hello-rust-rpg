...
impl BspDungeonBuilder {
    ...
    fn add_subrects(&mut self, rect: Rect) {
        ...
        self.rects.push(Rect::new(rect.x1, rect.y1, half_width, half_width));
        self.rects.push(Rect::new(rect.x1 + half_width, rect.y1, half_width, half_width));
        self.rects.push(Rect::new(rect.x1, rect.y1 + half_height, half_width, half_width));
        self.rects.push(Rect::new(rect.x1 + half_width, rect.y1 + half_height, half_width, half_width));
    }
